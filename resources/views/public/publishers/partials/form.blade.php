...
<div class="form-group">
    ...
    <input type="text" class="form-control {{ $errors->has('web')?"is-invalid":"" }}" id="web" name="web" placeholder="Introduce the publisher web" value="{{ isset($publisher)?$publisher->web:old('web') }}"required>
	@if( $errors->has('web'))
	<div class="invalid-feedback">
		{{ $errors->first('web') }}
	</div>
